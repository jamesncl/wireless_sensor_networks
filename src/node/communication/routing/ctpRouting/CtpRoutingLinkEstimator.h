#ifndef _CTPROUTINGLINKESTIMATOR_H_
#define _CTPROUTINGLINKESTIMATOR_H_
...
enum linkEstimatorTimers {
	
};



class CtpRoutingLinkEstimator : public CastaliaModule, public TimerService
{
	private:
		// NED file parameters:
...
#endif //_CTPROUTINGLINKESTIMATOR_H_